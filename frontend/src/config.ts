...
export const API_ALL_CATEGORIES_TREE: string = `${BACKEND_SHOP_URL}${API_CATEGORY_URL}/tree`;
export const API_ALL_CATEGORIES_FLAT: string = `${BACKEND_SHOP_URL}${API_CATEGORY_URL}/flat`;
